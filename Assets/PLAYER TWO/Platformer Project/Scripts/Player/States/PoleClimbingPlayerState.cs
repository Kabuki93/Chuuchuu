...
namespace PLAYERTWO.PlatformerProject
{
	...
	public class PoleClimbingPlayerState : PlayerState
	{
		...
		protected override void OnStep(Player player)
		{
			...
			player.transform.position = player.pole.ClampPointToPoleHeight(position, offset, out m_polePercentage);
		}
		...
		protected virtual void HandleVerticalMovement(Player player, Vector3 inputDirection)
		{
			...
			speed = Mathf.Clamp(speed, -player.stats.current.climbDownTopSpeed,
